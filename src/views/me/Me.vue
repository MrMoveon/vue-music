<template>
    <div class="mui-page music-me">
        <mui-scroll-view class="music-container" ref="meScrollV" name="me-scroll-v" direction="vertical" slidesPerView="auto" :scrollbar="null">
